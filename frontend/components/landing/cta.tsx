          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.6fr_1fr]">
            <div className="space-y-6 text-center lg:text-left">
              ...
              <p className="text-lg text-muted-foreground">
                Kokosave equips cooperative groups with automated payouts, transparent tracking, and DeFi yields from day one.
              </p>
              ...
              <div className="flex flex-col items-center gap-4 sm:flex-row lg:items-start">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="https://docs.kokosave.app" target="_blank" rel="noreferrer">
                    View docs
                  </Link>
                </Button>
              </div>

...
const metadata = {
  name: "Kokosave",
  description: "Decentralized Community Savings Platform powered by Somnia Data Streams",
  url:
...
// 6.5. Define Somnia Dream Testnet with RPC fallbacks
...
// 7. Set the networks - ONLY SOMNIA (removed other networks to prevent confusion)
...
export function Web3Provider({ children }: { children: ReactNode }) {
  // Log network configuration on mount
  if (typeof window !== "undefined") {
    console.log("🌐 Web3Provider Initialized:", {
      availableNetworks: networks.map(n => ({ id: n.id, name: n.name })),
